      ...
      process.env.VERCEL_ENV === "production" ? (
        <TutorialStep title="Set up redirect urls">
          ...
          <p className="mt-4">
            ...
            <span className="bg-muted text-secondary-foreground relative rounded border px-[0.3rem] py-[0.2rem] font-mono text-caption font-medium">
          ...
          <Link
            ...
            target="_blank"
            className="text-primary/50 hover:text-primary mt-4 flex items-center gap-1 text-body-sm"
          >
