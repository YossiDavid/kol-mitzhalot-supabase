...
-- ---------------------------------------------------------------------------
-- המפתחות זהים לאלה שבפרודקשן ולאלה שהפוטר מקשר אליהם — עם מקף. הדף
-- app/(website)/legal/[slug] מחפש את ה-slug כפי שהוא, בלי המרה, ולכן מפתח
-- עם קו תחתון אינו נגיש מאף כתובת והעמוד המשפטי נראה ריק.
-- הטקסט כולל את אותה הצהרת טיוטה שמופיעה בפרודקשן, כדי שהסביבה המקומית
-- תשקף את ההתנהגות האמיתית ולא תסתיר הבדלים.
INSERT INTO public.system_content (key, title, content)
VALUES
  (
    'terms-of-service',
    'תנאי שימוש (מקומי)',
    '<p><strong>גרסת טיוטה לדוגמה — אינה מסמך משפטי מחייב.</strong></p><p>תנאי שימוש פיקטיביים לסביבת פיתוח בלבד.</p>'
  ),
  (
    'privacy-policy',
    'מדיניות פרטיות (מקומי)',
    '<p><strong>גרסת טיוטה לדוגמה — אינה מדיניות פרטיות סופית.</strong></p><p>מדיניות פרטיות פיקטיבית לסביבת פיתוח בלבד.</p>'
  ),
  (
    'accessibility',
    'הצהרת נגישות (מקומי)',
    '<p><strong>גרסת טיוטה לדוגמה — תעודכן בהתאם לביקורת נגישות בפועל.</strong></p><p>הצהרת נגישות פיקטיבית לסביבת פיתוח בלבד.</p>'
  )
