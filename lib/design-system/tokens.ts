...
export const colorTokens: ColorSwatch[] = [
  ...
  },
  {
    ...
    fgClassName: "text-success-foreground",
    group: "semantic",
    description: "הצלחה / אושר",
  },
  {
    name: "success-muted",
    cssVar: "--success-muted",
    className: "bg-success-muted",
    fgClassName: "text-success-muted-foreground",
    group: "semantic",
    description: "רקע רך לתג הצלחה",
  },
  {
    name: "warning",
    cssVar: "--warning",
    className: "bg-warning",
    fgClassName: "text-warning-foreground",
    group: "semantic",
    description: "אזהרה / ממתין",
  },
  {
    name: "warning-muted",
    cssVar: "--warning-muted",
    className: "bg-warning-muted",
    fgClassName: "text-warning-muted-foreground",
    group: "semantic",
    description: "רקע רך לתג אזהרה",
  },
  {
    name: "info",
    cssVar: "--info",
    className: "bg-info",
    fgClassName: "text-info-foreground",
    group: "semantic",
    description: "מידע / בתהליך",
  },
  {
    name: "info-muted",
    cssVar: "--info-muted",
    className: "bg-info-muted",
    fgClassName: "text-info-muted-foreground",
    group: "semantic",
    description: "רקע רך לתג מידע",
  },
  {
